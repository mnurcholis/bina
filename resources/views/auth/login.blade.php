                  ...
                  <div class="col-md-6">
                    ...
                    <form class="mt-2 pt-2" method="POST" action="{{ route('loginPost2') }}">
                        ...
                        <div class="form-floating form-floating-custom mb-4 auth-pass-inputgroup">
                            ...
                            <button type="button" class="btn btn-link position-absolute h-100 end-0 top-0" id="password-addon" onclick="myFunction()">
                    ...
                    <button class="button button-secondary"><a href="{{ route('register') }}">Daftar</a></button>
                    <button class="button button-secondary"><a href="{{ route('home')}}">Kembali</button>
