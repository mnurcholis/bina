        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item">/</li>
                    <li class="breadcrumb-item active"><a href="{{ route('departements.index') }}">Departemen</a></li>
                </ol>
            </div>
    ...
    <div class="col-lg-6 col-xl-6 col-sm-12">
        <div class="card card-primary">
            <div class="card-header text-center bg-gray1" style="border-radius:10px 10px 0px 0px;">
                <h3 class="card-title text-white">Tambah Departement</h3>
            </div>
            <form method="POST" action="{{ route('departements.store') }}" novalidate>
                ...
                <div class="card-footer bg-gray1" style="border-radius:0px 0px 10px 10px;">
                    ...
                    <a href="{{ route('departements.index') }}" class="btn btn-secondary btn-footer">Kembali</a>
                </div>
            </form>
        </div>
    </div>
