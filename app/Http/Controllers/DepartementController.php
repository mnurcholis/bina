...
class DepartementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('departements.index')->with('success','Buat departement berhasil');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('departements.index')->with('success','Update departement berhasil');
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash('success', 'Hapus departement berhasil!');
