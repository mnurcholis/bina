        ...
        <div class="col-xl-4">
            <div class="card card-img">
                <div class="card-bod profile-card d-flex flex-column align-items-center">
                    <img class="rounded-circle profile-user mt-3" alt="{{ Str::limit(Auth::user()->name, '100', '') }}"
                        id="myImg" src="{{ asset('img/users/' . (Auth::user()->avatar ?? 'user.png')) }}">
                ...
                <div class="card-body pt-3">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bordered">
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link w-100 active" id="home-tab" data-bs-toggle="tab"
                                data-bs-target="#profile-detail" type="button" role="tab" aria-controls="home"
                                aria-selected="true">Detail</button>
                        </li>
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link w-100" id="profile-tab" data-bs-toggle="tab"
                                data-bs-target="#profile-edit" type="button" role="tab" aria-controls="profile"
                                aria-selected="false">Profile Ubah</button>
                        </li>
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link w-100" id="contact-tab" data-bs-toggle="tab"
                                data-bs-target="#profile-change-alamat" type="button" role="tab"
                                aria-controls="contact" aria-selected="false">Ganti Alamat</button>
                        </li>
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link w-100" id="contact-tab" data-bs-toggle="tab"
                                data-bs-target="#profile-change-password" type="button" role="tab"
                                aria-controls="contact" aria-selected="false">Ganti Password</button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content pt-2">
                        <div class="tab-pane fade show active profile-overview" id="profile-detail">
                            ...
                            <h3 class="judul mt-3 mb-3">Detail Profil</h3>
                            @foreach ($users as $user)
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label mb-2">Nama</div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label mb-2">Alamat Email</div>
                                    <div class="col-lg-9 col-md-8 mb-2">{{ $user->email }}</div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label mb-2">Telepon</div>
                                    <div class="col-lg-9 col-md-8 mb-2">{{ $user->telepon }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label mb-2">Peran</div>
                                    <div class="col-lg-9 col-md-8 mb-2">{{ $user->getRoleNames()[0] }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label mb-2">Alamat</div>
                                    <div class="col-lg-9 col-md-8 mb-2">
                                        @if ($user->Alamat)
                                            {{ $user->Alamat->Lokasi->province ?? '' }},
                                            {{ $user->Alamat->Lokasi->district ?? '' }},
                                            {{ $user->Alamat->Lokasi->subdistrict ?? '' }},
                                            {{ $user->Alamat->Lokasi->area ?? '' }},
                                            {{ $user->Alamat->alamat ?? '' }},
                                            {{ $user->Alamat->Lokasi->post_code ?? '' }}
                                        @endif
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="tab-pane fade profile-edit" id="profile-edit">
                            ...
                            <form action="{{ route('profile.update', $user->id) }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="role">Peran</label>
                                        <select hidden class="form-control" name="role">
                                            <option disabled selected>Pilih Hanya Satu Peran</option>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <img src="{{ asset('img/users/' . ($user->avatar ?? 'user.png')) }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password"
                                            ...
                                            name="password" value="{{ old('password') }}" placeholder="Password Lama">
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                        ...
                        <div class="tab-pane fade pt-3" id="profile-change-alamat">
                            <!-- Change Password Form -->
                            <form action="{{ route('profile.change-alamat', $user->id) }}" method="POST">
                                @method('patch')
                                @csrf
                                <div class="card-body">
                                    <div class="row">
